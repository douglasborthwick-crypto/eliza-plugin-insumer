...
export const insumerPlugin: Plugin = {
  name: "insumer",
  description:
    "Full autonomous agent lifecycle for condition-based commerce across 38 blockchains. 10 actions: buy API key, create merchant, configure token tiers, add credits, verify wallets, trust profiles, ACP/UCP commerce, confirm payments. ECDSA-signed results, never exposes balances.",
  actions: [
    verifyWalletAction,
    checkTrustAction,
